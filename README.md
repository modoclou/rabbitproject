# 🎬 MBTI 기반 영화 추천 웹사이트
Cinemine은 Cinema + mine(나의) 의 합성어로, 내 손 안의 작은 영화관을 뜻합니다.</br>
Cinemine은 MBTI와 성격 특징 기반으로 OpenAI가 영화를 선별하여 소개해 주는 사이트로, 취향에 맞는 숨은 영화를 찾을 수 있습니다.
...
<img width="1920" height="1080" alt="Image" src="https://github.com/user-attachments/assets/362f4c73-e0cb-4ee2-90f0-4703fefa99c3" />

#### 추천 결과 UI
포스터 사진에 마우스를 호버링하면 TMDB API로 데이터베이스에서 가져온 해당 영화 정보를 표시
<img width="1903" height="949" alt="Image" src="https://github.com/user-attachments/assets/2297bb48-7be2-430f-a59a-f0b96e86b190" />
<img width="1902" height="947" alt="Image" src="https://github.com/user-attachments/assets/7f9f2e9d-de82-4737-8f06-53bd13cd788b" />
